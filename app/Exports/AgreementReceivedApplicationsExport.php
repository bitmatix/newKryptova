...
class AgreementReceivedApplicationsExport implements FromCollection, WithHeadings
{
    protected $id;
    ...
    public function collection()
    {
        ...
        $data = $data->where('applications.status', '6')->where('users.is_white_label', '0')->get();
