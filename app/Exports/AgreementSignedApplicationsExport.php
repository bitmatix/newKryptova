...
class AgreementSignedApplicationsExport implements FromCollection, WithHeadings
{
    protected $id;
    ...
    public function collection()
    {
        ...
        if (!empty($slave_connection)) {
            ...
            _WriteLogsInFile($getDatabaseName . " connection from admin agreement signed application", 'slave_connection');
        }
        ...
        $data = $data->where('applications.status', '11')->get();
        return $data;
    }
