...
class RejectedApplicationsExport implements FromCollection, WithHeadings
{
    protected $id;
    ...
    public function collection()
    {
        ...
        if (!empty($slave_connection)) {
            ...
            _WriteLogsInFile($getDatabaseName . " connection from admin rejected application", 'slave_connection');
        }
        ...
        $data = $data->where('applications.status', '3')->get();
        return $data;
    }
