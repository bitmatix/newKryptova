...
class TerminatedApplicationsExport implements FromCollection, WithHeadings
{
    protected $id;
    ...
    public function collection()
    {
        ...
        if (!empty($slave_connection)) {
            ...
            _WriteLogsInFile($getDatabaseName . " connection from admin terminated application", 'slave_connection');
        }
        ...
        $data = $data->where('applications.status', '8')->get();
