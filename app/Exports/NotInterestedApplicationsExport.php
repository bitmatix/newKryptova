...
class NotInterestedApplicationsExport implements FromCollection, WithHeadings
{
    protected $id;
    ...
    public function collection()
    {
        ...
        if (!empty($slave_connection)) {
            ...
            _WriteLogsInFile($getDatabaseName . " connection from admin not interasted application", 'slave_connection');
        }
        ...
        $data = $data->where('applications.status', '7')->get();
