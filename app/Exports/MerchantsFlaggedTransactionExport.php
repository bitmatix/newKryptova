...
class MerchantsFlaggedTransactionExport implements FromCollection, WithHeadings, WithMapping
{
    /**
    ...
    */
    public function collection()
    {
        ...
        $data = $data->whereNotIn('transactions.payment_gateway_id', ['1','2'])->whereIn('transactions.user_id',$userIds)
    ...
    public function map($data): array
    {
        ...
        return [
            ...
            $data->reason,
            $data->is_flagged,
            convertDateToLocal($data->flagged_date, 'd-m-Y H:i:s'),
