...
class AgreementSentApplicationsExport implements FromCollection, WithHeadings
{
    protected $id;
    ...
    public function collection()
    {
        ...
        if (!empty($slave_connection)) {
            ...
            _WriteLogsInFile($getDatabaseName . " connection from admin agreement send application", 'slave_connection');
        }
        ...
        $data = $data->where('applications.status', '5')->get();
        return $data;
    }
