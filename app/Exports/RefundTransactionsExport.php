...
class RefundTransactionsExport extends DefaultValueBinder implements FromCollection, WithHeadings, WithCustomValueBinder, WithMapping
{
    protected $id;
    ...
    public function collection()
    {
        ...
        $data = $data->join('middetails', 'middetails.id', 'transactions.payment_gateway_id')->where('transactions.refund', '1');
    ...
    public function map($transactions): array
    {
        ...
        return [
            ...
            convertDateToLocal($transactions->refund_date, 'd-m-Y H:i:s'),
        ];
    }
