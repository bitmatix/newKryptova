...
class TestTransactionsExport extends DefaultValueBinder implements FromCollection, WithHeadings, WithMapping, WithCustomValueBinder
{
    protected $id;
    ...
    public function collection()
    {
        ...
        $data = \DB::table("transactions")->where('user_id', Auth::user()->id)->whereIn('transactions.payment_gateway_id', $payment_gateway_id);
