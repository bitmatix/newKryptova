        ...
        if (isset($reserve_response['reservation']) && $reserve_response['reservation'] != null) {
            ...
            if (isset($card_response['status']) && $card_response['status'] = 'RUNNING_CHECKS') {
                ...
                return [
                    ...
                    'redirect_3ds_url' => route('Wyre.form', ['session_id' => $input['session_id'], 'amount' => $input['amount'], 'currency' => $input['currency'], 'walletOrderId' => $card_response['id'], 'reservation' => $reserve_response['reservation']])
                ];
