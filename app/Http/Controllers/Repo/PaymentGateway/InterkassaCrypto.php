...
class InterkassaCrypto extends Controller
{
    ...
    public function checkout($input, $check_assign_mid)
    {
        ...
        try {
            ...
            $url = "https://sci.interkassa.com/?ik_co_id=".$ik_co_id."&ik_pm_no=".$pmNo."&ik_am=".$input['amount']."&ik_cur=".$input['currency']."&ik_desc=Payment+Description&ik_sign=".$sign."&ik_suc_u=".$success_url."&ik_fal_u=".$fail_url."#/paysystemList";
