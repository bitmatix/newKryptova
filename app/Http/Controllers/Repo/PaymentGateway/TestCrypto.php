...
class TestCrypto extends Controller
{
    ...
    public function checkout($input, $check_assign_mid)
    {
        return [
            ...
            'redirect_3ds_url' => route('test-crypto-transaction',$input['session_id']),
        ];       
    }

    public function testCryptoForm(Request $request, $session_id)
    {
        ...
        return view('gateway.testcryptoform', compact('session_id', 'request_data'));
    }

    public function testCryptoFormSubmit(Request $request, $session_id)
    {   
