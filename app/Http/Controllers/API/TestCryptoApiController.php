...
use App\Http\Controllers\Repo\TestCryptoTransactionRepo;

class TestCryptoApiController extends Controller
{
    // ================================================
    /* method : __construct
    * @param  :
    ...
    */// ==============================================
    public function __construct()
    {
        ...
        $this->CryptoTransactionRepo = new TestCryptoTransactionRepo;
    }
    ...
    */// ==============================================
    public function store(Request $request)
    {
        ...
        $request->merge([
            'payment_type' => $request->payment_type ?? 'crypto',
            'request_from_ip' => $request->ip(),
            'request_origin' => $_SERVER['HTTP_HOST'],
            'is_request_from_vt' => 'CRYPTO TEST API',
        ...
        $return_data = $this->CryptoTransactionRepo->store($requestInput);
