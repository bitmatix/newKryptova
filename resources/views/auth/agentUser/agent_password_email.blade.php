...
<html lang="en">
	...
	<head>
	    ...
	    <meta name="description" content="{{ config('app.name') }} Agent Login">
			...
			<div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url('{{ storage_asset('/theme/assets/media/illustrations/sigma-1/14-dark.png') }}');">
				...
				<div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
					...
					<div class="w-lg-550px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
						<!--begin::Form-->
						<form action="{{ route('rp-password-email') }}" aria-label="{{ __('Reset Password') }}" method="post" class="form w-100" novalidate="novalidate" id="kt_new_password_form">
						{!! csrf_field() !!}
							<!--begin::Heading-->
