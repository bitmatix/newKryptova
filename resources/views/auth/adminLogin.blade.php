...
<html lang="en">
	...
	<head>
	    ...
	    <meta name="description" content="{{ config('app.name') }} Admin Login">
			...
			<div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url('{{ storage_asset('/theme/assets/media/illustrations/sigma-1/14-dark.png') }}');">
				...
				<div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
					...
					<a href="{{ route('admin/login') }}" class="mb-12">
						<img alt="Logo" src="{{ storage_asset('theme/assets/images/logo.png') }}" style="width: 400px;" />
					</a>
					<!--end::Logo-->
					<!--begin::Wrapper-->
					<div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
						<!--begin::Form-->
						<form action="{{ URL::route('admin/login') }}" id="kt_sign_in_form" method="post" class="form w-100" novalidate="novalidate">
                        {!! csrf_field() !!}
							<!--begin::Heading-->
							...
							<div class="fv-row mb-10">
								...
								<div class="d-flex flex-stack mb-2">
									...
									<!--end::Label-->
									<!--begin::Link-->
									<a href="{{ route('admin-password-reset') }}" class="link-primary fs-6 fw-bolder">Forgot Password ?</a>
									<!--end::Link-->
								</div>
								<!--end::Wrapper-->
								<!--begin::Input-->
