...
<div class="row g-5 g-xl-8">
    ...
    <div class="col-xl-8">
        ...
        <div class="card card-xxl-stretch mb-5 mb-xl-8">
            ...
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bolder fs-3 mb-1">Latest Transactions</span>
                ...
                <div class="card-toolbar">
                    <ul class="nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-dark fw-bolder px-4 me-1" data-bs-toggle="tab" href="">Week</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-dark fw-bolder px-4" data-bs-toggle="tab" href="">Day</a>
                        </li>
                    </ul>
                </div>
            </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <label class="light badge-sm badge badge-info">To Be Confirm</label>
                                            @else
...
@endsection
@section('content')
@if(auth()->guard('agentUser')->user()->referral_code != NULL || auth()->guard('agentUser')->user()->referral_code != '')
<div class="row">
            ...
            <div class="card-body p-4">
                <div class="media ai-icon">
                    ...
                    <div class="media-body">
                        <h4 class="mb-0">Your Referral Link</h4>
                        <p class="mb-1">Your personal referral link for merchant registration</p>
                        <span class="badge badge-primary" id="link" data-link="{{config('app.url')}}/register?RP={{ auth()->guard('agentUser')->user()->referral_code }}">{{config('app.url')}}/register?RP={{ auth()->guard('agentUser')->user()->referral_code }}</span>
                        <span class="badge-danger badge" id="Copy" style="cursor: pointer;">Copy</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-header flex-wrap border-0 pb-0">
                <h4 class="text-black fs-20 mb-3">Transaction Overview</h4>
            </div>
            <div class="card-body pt-0">
                <div class="row align-items-center">
                    <div class="col-lg-4 mb-lg-0 mb-4 text-center radialBar">
                        <div id="radialBar"></div>
                        <h4 style="margin: -35px 0px 0px 0px;">Successful </h4>
                        <span>Total Count {{ $transaction->successfullC }}</span>
                    </div>
                    <div class="col-lg-8">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center mb-sm-5 mb-3">
                                    <div class="d-inline-block relative donut-chart-sale mr-3">
                                        <span class="donut"
                                            data-peity='{ "fill": ["#887962", "rgba(236, 236, 236, 1)"],   "innerRadius": 34, "radius": 10}'>{{number_format($transaction->chargebackP,2)}}/100</span>
                                        <small>
                                            <lord-icon src="https://cdn.lordicon.com/ezvyzsqg.json" trigger="loop" colors="primary:#121331,secondary:#08a88a" style="width:50px;height:50px"></lord-icon>
                                        </small>
                                    </div>
                                    <div>
                                        <h4 class="fs-18 text-black">Chargeback ({{ number_format($transaction->chargebackP,2) }}%)</h4>
                                        <span>Total Count {{ $transaction->chargebackC }}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center mb-sm-5 mb-3">
                                    <div class="d-inline-block relative donut-chart-sale mr-3">
                                        <span class="donut"
                                            data-peity='{ "fill": ["rgb(212, 228, 228)", "rgba(236, 236, 236, 1)"],   "innerRadius": 34, "radius": 10}'>{{number_format($transaction->suspiciousP,2)}}/100</span>
                                        <small>
                                            <lord-icon src="https://cdn.lordicon.com//rvruzzcr.json" trigger="loop" colors="primary:#121331,secondary:#08a88a" style="width:50px;height:50px"></lord-icon>
                                        </small>
                                    </div>
                                    <div>
                                        <h4 class="fs-18 text-black">Suspicious ({{ number_format($transaction->suspiciousP,2) }}%)</h4>
                                        <span>Total Count {{ $transaction->suspiciousC }}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center mb-sm-0 mb-3">
                                    <div class="d-inline-block relative donut-chart-sale mr-3">
                                        <span class="donut"
                                            data-peity='{ "fill": ["#000000", "rgba(236, 236, 236, 1)"],   "innerRadius": 34, "radius": 10}'>{{ number_format($transaction->declinedP,2) }}/100</span>
                                        <small>
                                            <lord-icon src="https://cdn.lordicon.com//sjwcaomq.json" trigger="loop" colors="primary:#121331,secondary:#08a88a" style="width:50px;height:50px"></lord-icon>
                                        </small>
                                    </div>
                                    <div>
                                        <h4 class="fs-18 text-black">Declined ({{ number_format($transaction->declinedP,2) }}%)</h4>
                                        <span>Total Count {{ $transaction->declinedC }}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center mb-sm-0 mb-3">
                                    <div class="d-inline-block relative donut-chart-sale mr-3">
                                        <span class="donut"
                                            data-peity='{ "fill": ["#E89C86", "rgba(236, 236, 236, 1)"],   "innerRadius": 34, "radius": 10}'>{{ number_format($transaction->refundP,2) }}/100</span>
                                        <small>
                                            <lord-icon src="https://cdn.lordicon.com//kkbyjlau.json" trigger="loop" colors="primary:#121331,secondary:#08a88a" style="width:50px;height:50px"></lord-icon>
                                        </small>
                                    </div>
                                    <div>
                                        <h4 class="fs-18 text-black">Refund ({{ number_format($transaction->refundP,2) }}%)</h4>
                                        <span>Total Count {{ $transaction->refundC }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="col-xl-12 col-lg-12">
        <div class="card">
            <div class="card-header">
                ...
                <a href="{!! url('rp/user-management') !!}" class="btn btn-info btn-rounded">View All <i
    ...
    <div class="col-xl-12 col-lg-12">
        <div class="card">
            <div class="card-header">
                ...
                <a href="{!! url('rp/merchant-transactions') !!}" class="btn btn-info btn-rounded">View All <i
                        class="fa fa-chevron-right"></i></a>
            </div>
            <div class="card-body">
                <div class="table-responsive">
