        ...
        <div class="header-menu align-items-stretch h-lg-75px" data-kt-drawer="true" data-kt-drawer-name="header-menu" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_header_menu_mobile_toggle" data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_body', lg: '#kt_header_nav'}">
            ...
            <div class="menu menu-lg-rounded menu-column menu-lg-row menu-state-bg menu-title-gray-700 menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-400 fw-bold my-5 my-lg-0 align-items-stretch" id="#kt_header_menu" data-kt-menu="true">
                <div class="menu-item me-lg-1">
                    <a class="menu-link active py-3" href="{!! url('rp/dashboard') !!}">
                        <span class="menu-title">Dashboard</span>
                    </a>
                </div>
                <div class="menu-item me-lg-1">
                    <a class="menu-link py-3" href="{{route('rp.user-management')}}">
                    ...
                    <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                        ...
                        <div class="menu-item">
                            <a class="menu-link py-3" href="#">
                                ...
                                <span class="menu-title">Pre Approval</span>
                            </a>
                        </div>
                        <div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" class="menu-item menu-lg-down-accordion">
                            <span class="menu-link py-3">
                                ...
                                <span class="menu-title">Rate & Agreements</span>
                            ...
                            <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                                <div class="menu-item">
                                    <a class="menu-link py-3" href="#">
                                        ...
                                        <span class="menu-title">Rate Accepted</span>
                                    </a>
                                </div>
                                <div class="menu-item">
                                    <a class="menu-link py-3" href="#">
                                        ...
                                        <span class="menu-title">Rate Decline</span>
                                    </a>
                                </div>
                                <div class="menu-item">
                                    <a class="menu-link py-3" href="#">
                                        ...
                                        <span class="menu-title">Application-Sent Agreements</span>
                                    </a>
                                </div>
                                <div class="menu-item">
                                    <a class="menu-link py-3" href="#">
                                        ...
                                        <span class="menu-title">Application-Signed Agreements</span>
                                    </a>
                                </div>
                                <div class="menu-item">
                                    <a class="menu-link py-3" href="#">
                                        ...
                                        <span class="menu-title">Application-Received Agreements</span>
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="menu-item">
                            <a class="menu-link py-3" href="#">
                                ...
                                <span class="menu-title">Not Interested</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link py-3" href="#">
                                ...
                                <span class="menu-title">Terminated</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link py-3" href="#">
                    ...
                    <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                        ...
                        <div class="menu-item">
                            <a class="menu-link py-3" href="#">
                                ...
                                <span class="menu-title">Crypto Transactions</span>
                            </a>
                        </div>
                        ...
                        <div class="menu-item">
                            <a class="menu-link py-3" href="#">
                                ...
                                <span class="menu-title">Chargebacks</span>
                            </a>
                        </div>
                        ...
                        <div class="menu-item">
                            <a class="menu-link py-3" href="#">
                                ...
                                <span class="menu-title">Retrieval</span>
                            </a>
                        </div>
                        ...
                        <div class="menu-item">
                            <a class="menu-link py-3" href="#">
                                ...
                                <span class="menu-title">Suspicious</span>
                            </a>
                        </div>
                        ...
                        <div class="menu-item">
                            <a class="menu-link py-3" href="#">
                                ...
                                <span class="menu-title">Test Transactions</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link py-3" href="#">
                                ...
                                <span class="menu-title">Remove Suspicious Transactions</span>
                            </a>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="d-flex flex-stack py-4">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="mb-0 me-2">
                                            ...
                                            <div class="text-gray-400 fs-7">New frontend rp theme</div>
                                        </div>
                                        <!--end::Title-->
                                    </div>
                                    <!--end::Section-->
            ...
            <div class="d-flex align-items-center ms-3 ms-lg-5" id="kt_header_user_menu_toggle">
                ...
                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 w-350px" data-kt-menu="true">
                    ...
                    <div class="menu-item px-3">
                        <div class="menu-content d-flex align-items-center px-3">
                            ...
                            <div class="d-flex flex-column">
                                <div class="fw-bolder d-flex align-items-center fs-5">{{ucwords(auth()->guard('agentUser')->user()->name)}}
                                <span class="badge badge-light-success fw-bolder fs-8 px-2 py-1 ms-2"></span></div>
                                <a href="#" class="fw-bold text-muted text-hover-primary fs-7">{{Auth::guard('agentUser')->user()->email}}</a>
                            </div>
                            <!--end::Username-->
                        </div>
                    </div>
                    ...
                    <div class="menu-item px-5">
                        <a href="{!! route('profile-rp') !!}" class="menu-link px-5">My Profile</a>
                    </div>
                    <!--end::Menu item-->
                    <div class="menu-item px-5">
                        <a href="{!! URL::route('rp/logout') !!}" class="menu-link px-5">Sign Out</a>
                    </div>
                    <!--end::Menu item-->
                </div>
                <!--end::Menu-->
