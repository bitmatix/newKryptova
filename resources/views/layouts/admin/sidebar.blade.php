<div id="kt_aside_menu_wrapper" class="w-100 hover-scroll-overlay-y d-flex" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_search, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside, #kt_aside_menu" data-kt-scroll-offset="100px">
    <div id="kt_aside_menu" class="menu menu-column menu-title-gray-600 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-icon-gray-400 menu-arrow-gray-400 fw-bold fs-6 my-auto" data-kt-menu="true">
        <div class="menu-item py-1">
            <a class="menu-link {{ $pageActive == 'dashboard' ? 'active' : ''  }} scroll-ps" href="{{ route('dashboard') }}" title="Dashboard" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="left">
            ...
            <div class="menu-sub menu-sub-dropdown w-225px px-1 py-4">
                ...
                <div class="menu-item">
                    <a class="menu-link" href="#">
                        ...
                        <span class="menu-title">Gateway Management</span>
                    </a>
                </div>
                <div class="menu-item">
                    <a class="menu-link" href="#">
                        ...
                        <span class="menu-title">MIDs List</span>
                    </a>
                </div>
                <div class="menu-item">
                    <a class="menu-link" href="#">
            ...
            <div class="menu-sub menu-sub-dropdown w-225px px-1 py-4">
                ...
                <div class="menu-item">
                    <a class="menu-link" href="#">
                        ...
                        <span class="menu-title">Merchant Transaction</span>
                    </a>
                </div>
                <div class="menu-item">
                    <a class="menu-link" href="#">
                        ...
                        <span class="menu-title">Auto Suspicious System</span>
                    </a>
                </div>
            </div>
        </div>
        ...
        <div data-kt-menu-trigger="click" data-kt-menu-flip="false" data-kt-menu-placement="left-start" class="menu-item py-1">
            ...
            <div class="menu-sub menu-sub-dropdown w-225px px-1 py-4">
                <div class="menu-item">
                    <div class="menu-content">
                        <span class="menu-section fs-5 fw-bolder ps-1 py-1">Payout</span>
                    </div>
                </div>
                <div class="menu-item">
                    <a class="menu-link" href="#">
                        ...
                        <span class="menu-title">Generate Payout Report</span>
                    </a>
                </div>
                <div class="menu-item">
                    <a class="menu-link" href="#">
                        ...
                        <span class="menu-title">Generate Referral Partner's Report</span>
                    </a>
                </div>
                <div class="menu-item">
                    <a class="menu-link" href="#">
                        ...
                        <span class="menu-title">Referral Partner's Report</span>
                    </a>
                </div>
            </div>
        </div>
